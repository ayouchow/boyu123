    ...
    <div class="deanfooter">
        ...
        <div class="deanftbottom">
        	<div class="w1180">
                ...
                <p>
                    <a href="http://ss.ayouchow.com" target="_blank">AyouChow!</a> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}-->&copy; 2001-2013 <a href="$_G['setting']['siteurl']" target="_blank">$_G['setting']['sitename']</a>&nbsp;&nbsp;威海迪恩网络科技有限公司&nbsp;版权所有<br><a href="#" target="_blank">中国互联网举报中心</a>&nbsp;<a href="#" target="_blank">北京12318文化市场举报热线</a>&nbsp;<a href="#" target="_blank">网络110报警服务</a>&nbsp;<!--{if $_G['setting']['icp']}--><a href="http://www.miitbeian.gov.cn/" target="_blank">$_G['setting']['icp']</a><!--{/if}--> | 业务许可证：B1.B2-20140071
                </p>
        </div>
    </div>
    </div>
...
<!--{/if}-->
<div style="display:none"><script src="http://s11.cnzz.com/z_stat.php?id=1256403958&web_id=1256403958" language="JavaScript"></script></div>

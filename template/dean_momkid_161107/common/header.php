		...
		<div id="hd">
                    ...
                    <div class="deanhdtopl">
                       ...
                       <a href="#" target="_blank" class="deantopweixin">
                       		<div class="deanweixintips">
                            	<img src="$_G['style'][styleimgdir]/qcode.jpg">
                                <p>扫一扫关注官方微信</p>
                            </div>
                       </a> 
                       ...
                       <!--{loop $_G['setting']['topnavs'][0] $nav}-->
						<!--{if $nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))}-->$nav[code]<!--{/if}-->
						<!--{/loop}-->
                        <div class="deantelnums">010-45789654</div>
                        <div class="deanemailnums">green@dean.com</div>
						<!--{hook/global_cpnav_extra1}-->
                        <div class="clear"></div>
                    </div>
            ...
            <div class="deanheaderbg">
            	<div class="w1180">
                    ...
                    <!--天气预报调用代码插入点开始-->
                    <iframe allowtransparency="true" scrolling="no" src="//tianqi.2345.com/plugin/widget/index.htm?

s=1&amp;z=1&amp;t=0&amp;v=0&amp;d=1&amp;bd=0&amp;k=000000&amp;f=808080&amp;q=1&amp;e=0&amp;a=1&amp;c=54511&amp;w=195&amp;h=96&amp;align=center"

height="96" frameborder="0" width="195"></iframe>
                    <!--天气预报调用代码插入点结束-->
                    </div>
